...
class Game {
    constructor(height, width) {
        ...
        this.toggle = true;
        this.gameOver = false;
        this.word = localStorage.getItem("r_number");
    ...
    updateCountdown() {
        const updateHour = 12; // The hour when the update will occur (e.g., 15 for 
...
window.onload = function () {
    ...
    if (!localStorage.getItem("r_number")) {
        const initialWord = getNumbersimple();
        const currentDate = getCurrentDate();
